...
| [`mtk-protocol.md`](./mtk-protocol.md) | On-the-wire MediaTek BROM + DA v5 / v6 + SLA + scatter / OFP / OPS framing reference, distilled from the OPPO `FlashToolLib.dll` exports and cross-checked against `bkerler/mtkclient`. Drives the implementation of [`tools/kaeru-mtk/`](../../tools/kaeru-mtk/), the open-source Windows-first Python flasher / dumper / unlocker. |
